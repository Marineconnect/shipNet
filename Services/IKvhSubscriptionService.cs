...
public interface IKvhSubscriptionService
{
    ...
    Task<KvhSyncHistoryPageResult> GetSyncHistoryAsync(KvhSyncHistoryFilter filter, int page, int pageSize, int? allowedTenantId = null, int? allowedDeviceId = null, CancellationToken cancellationToken = default);
